...
```java
for (int i = 1; i <= 10; i++){
    User user=new User(i,"Muskan",22,"MCA");
...
> {"id":1, "name":"Muskan", "age":22, "course":"MCA"}
> 
> {"id":2, "name":"Muskan", "age":22, "course":"MCA"}
> 
> {"id":3, "name":"Muskan", "age":22, "course":"MCA"}
> 
> {"id":4, "name":"Muskan", "age":22, "course":"MCA"}
> 
> {"id":5, "name":"Muskan", "age":22, "course":"MCA"}
> 
